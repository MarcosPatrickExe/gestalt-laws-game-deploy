...
//import {ReactComponent as PlacaTorreRelogio} from "..images/telaSelecao/placa2.svg";

export default class Placa1{
    render(){
        return(
            <svg id="Layer_1" dataName="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 478.98 120.46">
            <defs>
                </defs><title>placa1</title>
...
/*
     <style>
                ...
                .cls-3, .cls-4,.cls-5{strokeMiterlimit: 10; strokeWidth: 3}
                .cls-4,.cls-5{fill: none} .cls-5{stroke: #73543b}
             </style> */